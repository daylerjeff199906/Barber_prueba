        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2 logo">Jheyk| Tattoo Barberia</h2>
              <?php
...
?>
              <p><?php  echo substr($row['PageDescription'],0,300);?> <a href="about.php">...</a></p><?php } ?>
...
?>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  2023 &copy; JHEYk|Tatto Barber  </p>
          </div>
        </div>
      </div>
    </footer>